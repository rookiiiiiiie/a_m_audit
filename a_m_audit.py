...
class a_m_audit_Plugin_t(idaapi.plugin_t):
    comment = "a_m_audit plugin for IDA Pro"
    help = "todo"
    wanted_name = "a_m_audit"
  ...
  \     /     \     /     \     /     
   \   /       \   /       \   /         
    \ /         \ /         \ /            
     V           V           V             
  a   m         a   u   d   i   t           
        re-edit by rookiiiiiiie  2025.3.1
            '''
            print(start)
            print("=" * 80)
